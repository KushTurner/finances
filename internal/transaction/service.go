...
type Service interface {
	...
	AddTransactions(ctx context.Context, transactions []Transaction) (int64, error)
}
...
func (s *service) AddTransactions(ctx context.Context, transactions []Transaction) (int64, error) {
